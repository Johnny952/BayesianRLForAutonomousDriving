...
u_filepath = "../logs/train_agent_20230715_211724_ae_v14/"
u_agent_name = "5950097"
use_safe_action = True

case = "all"  # 'all', 'uncert'

thresh_range = [5*(i+1) for i in range(10)]
history_length = 20
start_saving = 3
if debug:
    save_video = True
...
policy = MixEWMATestPolicy(alpha=1.25, safe_action=3, offset=None)
dqn = MixDQNAgent(
    q_model=q_dqn,
    u_model=u_dqn,
    policy=policy,
